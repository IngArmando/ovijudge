	...
	if (var_check('chatsettings_submit')) 
	{
		...
		$result = $db->execute("
			...
			SET config_value = CASE 
				...
				WHEN config_name = 'disable_chat' THEN '" . get_var('disable_chat') . "'
		...
		{	
			...
			$disable_chat = get_var('disable_chat');
