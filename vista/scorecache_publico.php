<?php
require_once("vista/campo/campo_scorecache_publico.php");
class vista_scorecache_publico extends campo_scorecache_publico{
		...
		public function reporte_html_general($vista){
			...
			var sub_titulo_pdf="Reporte de Score cache del publico";
			</script>
			...
			<div class="panel-heading" style="text-align:center">
				<div class="row">
					...
					<div class="col-md-4" style="text-align:center">
						<span style="font-size:18px"><span class="glyphicon glyphicon-user"></span> Score cache del publico</span>					
					</div>
		...
		$html= '
			...
			<div class="panel-heading" style="text-align:center">
				<div class="row">
					...
					<div class="col-md-6"><span style="font-size:18px"><span class="glyphicon glyphicon-user"></span> Consulta detallada de Score cache del publico</span></div>
					<div class="col-md-3">'.btn_regresar('scorecache_publico').'</div>
				</div>
			</div>
			<div class="panel-body">
		...
		public function formulario($tipo){
			switch($tipo){
				case 'modificar': {
					...
					$titulo='Modificar Score cache del publico';
				}break;
				case 'registrar':{
					$boton=botones('registrar');
					$titulo='Agregar Nuevo Score cache del publico';
				}break;
			}
		$html= '
			<form method="post" action="?vista=scorecache_publico">
			<script type="text/javascript" src="js/js_scorecache_publico.js" ></script>
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align:center">
					<div class="row">
						...
						<div class="col-md-2 col-md-offset-1">'.btn_regresar('scorecache_publico').'</div>
					</div>
				</div>
