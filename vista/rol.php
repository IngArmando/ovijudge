...
<div class="panel-heading">
				...
				<a title="Agregar nuevo registro" class="btn btn-success btn-sm" href="?vista=rol&evento=nuevo">Agregar Roles</a>
				...
				<a class="btn btn-default btn-sm" href="?vista=rol"  style="float:right; <?php if($_GET['evento']!='nuevo' and $_POST['evento']!='consultar') echo 'display:none;';?>">
...
if($mostrar_formulario==true){
	echo '<form method="post" action="?vista=rol">';
